...
function AccountProfile() {
    ...
    const onCascaderChange = useCallback((value, selectedOptions) => {
        ...
        setAddressId(selectedOptions ? selectedOptions[selectedOptions.length - 1].id : null);
        setValidateStatus('');
        setHelp('');
    }, []);
                        ...
                        <div className={cx('t grid grid-cols-2 gap-4')}>
                            <div className={cx('grid-rows-2 gap-4')}>
                                <div className={cx('row-span-1 ')}>
                                    ...
                                    >
                                        <TextArea className={cx('max-h-[97px]')} rows={4}
                                                  placeholder='Địa chỉ tối đa 100 ký tự!'/>
                                    </Form.Item>
                                </div>
                            </div>
